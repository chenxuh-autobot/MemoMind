            ...
            val manifests = applyModelCatalogOverrides(
                manifests = listOf(
                    ModelManifest(
                        ...
                        displayName = "Qwen3-VL-2B 图文版",
                        recommendedMinRamGb = 12,
                        supportsVision = true,
                        supportsAudio = false,
                        recommendedMaxInput = 8000,
                        recommendedDeviceTier = DeviceTier.S,
                        estimatedStorageBytes = 2_280_000_000,
                        assets = listOf(
                            ModelAsset(
                                fileName = "tokenizer.txt",
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/tokenizer.txt",
                            ...
                            ModelAsset(
                                fileName = "llm.mnn",
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/llm.mnn",
                            ...
                            ModelAsset(
                                ...
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/llm.mnn.weight",
                            ...
                            ModelAsset(
                                ...
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/llm_config.json",
                            ...
                            ModelAsset(
                                ...
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/config.json",
                            ...
                            ModelAsset(
                                fileName = "visual.mnn",
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/visual.mnn",
                                sha256 = "todo-visual-mnn-sha256",
                                kind = ModelAssetKind.MODEL_GRAPH,
                                sizeBytes = 1_500_000,
                            ),
                            ModelAsset(
                                fileName = "visual.mnn.weight",
                                downloadUrl = "https://example.com/models/qwen-vl-2b-instruct-mnn/visual.mnn.weight",
                                sha256 = "todo-visual-weight-sha256",
                                kind = ModelAssetKind.MODEL_WEIGHT,
